...
- 子の設定上限は8です。小規模は0〜1体、通常は2〜4体、独立した大きな作業は5〜8体を目安とし、人数を埋めるために仕事を作りません。実際の人数は設定枠、ホストの空き枠、着手可能な独立タスク数、CPU・メモリ・外部APIの余力で絞ります。新しい環境では4→6→8と段階的に起動・終了と品質・時間・使用量を確認し、上限値を実測済みの能力と混同しません。
