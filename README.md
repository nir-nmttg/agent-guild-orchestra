...
python3: error: couldn't create cache file '/tmp/xcrun_db-liadXobT' (errno=Operation not permitted)
2026-08-13 01:24:47.732 xcodebuild[28879:30777722]  DVTFilePathFSEvents: Failed to start fs event stream.
2026-08-13 01:24:47.868 xcodebuild[28879:30777721] [MT] DVTDeveloperPaths: Failed to get length of DARWIN_USER_CACHE_DIR from confstr(3), error = Error Domain=NSPOSIXErrorDomain Code=5 "Input/output error". Using NSCachesDirectory instead.
python3: warning: confstr() failed with code 5: couldn't get path of DARWIN_USER_TEMP_DIR; using /tmp instead
python3: error: couldn't create cache file '/tmp/xcrun_db-zXKYwL61' (errno=Operation not permitted)
2026-08-13 01:24:48.196 xcodebuild[28882:30777740]  DVTFilePathFSEvents: Failed to start fs event stream.
2026-08-13 01:24:48.293 xcodebuild[28882:30777739] [MT] DVTDeveloperPaths: Failed to get length of DARWIN_USER_CACHE_DIR from confstr(3), error = Error Domain=NSPOSIXErrorDomain Code=5 "Input/output error". Using NSCachesDirectory instead.
